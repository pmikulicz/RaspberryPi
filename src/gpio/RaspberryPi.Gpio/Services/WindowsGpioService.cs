// --------------------------------------------------------------------------------------------------------------------
// <copyright file="WindowsGpioService.cs" company="Patryk Mikulicz">
//   Copyright (c) 2016 Patryk Mikulicz.
// </copyright>
// <summary>
//   Represents implmenetation of gpio service dedidcated for Windows platform
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace RaspberryPi.Gpio.Services
{
    ...
    /// Represents implmenetation of gpio service dedidcated for Windows platform
    /// </summary>
    internal sealed class WindowsGpioService : IGpioService
    {
        /// <summary>
